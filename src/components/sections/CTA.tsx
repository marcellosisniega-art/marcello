...
export default function CTA() {
  return (
    <section id="contacto" className="relative scroll-mt-24 overflow-hidden bg-ink-soft px-6 py-28 sm:px-10 sm:py-40 lg:px-16">
      <div className="pointer-events-none absolute left-1/2 top-0 h-[120%] w-[120%] -translate-x-1/2 -translate-y-1/3 rounded-full bg-gradient-to-b from-gold/10 via-transparent to-transparent blur-3xl" />
